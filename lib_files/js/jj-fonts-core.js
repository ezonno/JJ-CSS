...
count.async = true;
count.src = '//hello.myfonts.net/count/29061a';
...
var fonts = [{
    ...
    "url": wfpath + "29061A_0" + suffix + "_0." + webfontType
}, {
    "fontFamily": "FuturaBT-Medium",
    "url": wfpath + "29061A_1" + suffix + "_0." + webfontType
}, {
    "fontFamily": "FuturaBT-Heavy",
    "url": wfpath + "29061A_2" + suffix + "_0." + webfontType
}, {
