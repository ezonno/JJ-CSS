...
count.async = true;
count.src = '//hello.myfonts.net/count/290619';
...
if (/(Macintosh|Android)/.test(navigator.userAgent) && webfontType != "svg#wf")
    suffix = "_unhinted";
var fonts = [{
    "fontFamily": "CenturySchoolbookBT-Roman",
    "url": wfpath + "290619_0" + suffix + "_0." + webfontType
}, {
    "fontFamily": "PFDinMono-Medium",
    "url": wfpath + "290619_1" + suffix + "_0." + webfontType
}, {
    "fontFamily": "PFDinMono-Regular",
    "url": wfpath + "290619_2" + suffix + "_0." + webfontType
}, {
    "fontFamily": "PFDinMono-Bold",
    "url": wfpath + "290619_3" + suffix + "_0." + webfontType
}, 
/*{
    "fontFamily": "CourierLTCYR-Regular",
    "url": wfpath + "290619_4" + suffix + "_0." + webfontType
},
*/ {
    "fontFamily": "RockwellStd",
    "url": wfpath + "290619_5" + suffix + "_0." + webfontType
}];
