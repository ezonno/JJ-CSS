/*
 ...
 MyFonts Webfont Build ID 2708767, 2013-12-16T04:36:14-0500
 ...
 License: http://www.myfonts.com/viewlicense?type=web&buildid=2708767

 ? 2013 MyFonts Inc
*/
var protocol=document.location.protocol;"https:"!=protocol&&(protocol="http:");var count=document.createElement("script");count.type="text/javascript";count.async=!0;count.src=protocol+"//hello.myfonts.net/count/29551f";var s=document.getElementsByTagName("script")[0];s.parentNode.insertBefore(count,s);var browserName,browserVersion,webfontType;if("undefined"==typeof woffEnabled)var woffEnabled=!0;var svgEnabled=0;
...
for(var fonts=[{fontFamily:"PFDinMono-Medium",url:wfpath+"29551F_0"+suffix+"_0."+webfontType},{fontFamily:"PFDinMono-Regular",url:wfpath+"29551F_1"+suffix+"_0."+webfontType},{fontFamily:"PFDinMono-Bold",url:wfpath+"29551F_2"+suffix+"_0."+webfontType},{fontFamily:"GillSansMTStd-Medium",url:wfpath+"29551F_3"+suffix+"_0."+webfontType},{fontFamily:"GillSansMTStd-Book",url:wfpath+"29551F_4"+suffix+"_0."+webfontType}],len=fonts.length,css="",i=0;i<len;i++){var format="svg#wf"==webfontType?'format("svg")':
