/*
 ...
 MyFonts Webfont Build ID 2774196, 2014-03-20T11:23:02-0400
 ...
 License: http://www.myfonts.com/viewlicense?type=web&buildid=2774196

 ? 2014 MyFonts Inc
*/
var protocol=document.location.protocol;"https:"!=protocol&&(protocol="http:");var count=document.createElement("script");count.type="text/javascript";count.async=!0;count.src=protocol+"//hello.myfonts.net/count/2a54b4";var s=document.getElementsByTagName("script")[0];s.parentNode.insertBefore(count,s);var browserName,browserVersion,webfontType;if("undefined"==typeof woffEnabled)var woffEnabled=!0;var svgEnabled=0;
...
for(var fonts=[{fontFamily:"PFDinMono-Medium",url:wfpath+"2A54B4_0"+suffix+"_0."+webfontType},{fontFamily:"PFDinMono-Regular",url:wfpath+"2A54B4_1"+suffix+"_0."+webfontType},{fontFamily:"PFDinMono-Light",url:wfpath+"2A54B4_2"+suffix+"_0."+webfontType},{fontFamily:"PFDinMono-Bold",url:wfpath+"2A54B4_3"+suffix+"_0."+webfontType},{fontFamily:"AvenirLTStd-Black",url:wfpath+"2A54B4_4"+suffix+"_0."+webfontType},{fontFamily:"AvenirLTStd-Roman",url:wfpath+"2A54B4_5"+suffix+"_0."+webfontType},{fontFamily:"AvenirLT-Light",
url:wfpath+"2A54B4_6"+suffix+"_0."+webfontType},{fontFamily:"AvenirLT-Heavy",url:wfpath+"2A54B4_7"+suffix+"_0."+webfontType},{fontFamily:"GillSansMTStd-Medium",url:wfpath+"2A54B4_8"+suffix+"_0."+webfontType},{fontFamily:"GillSansMTStd-Book",url:wfpath+"2A54B4_9"+suffix+"_0."+webfontType}],len=fonts.length,css="",i=0;i<len;i++){var format="svg#wf"==webfontType?'format("svg")':"ttf"==webfontType?'format("truetype")':"eot"==webfontType?"":'format("'+webfontType+'")',css=css+("@font-face{font-family: "+
