/*
 ...
 MyFonts Webfont Build ID 2760786, 2014-03-04T08:12:53-0500
 ...
 License: http://www.myfonts.com/viewlicense?type=web&buildid=2760786
 Webfonts copyright: Copyright (c) 2010 Parachute&#x00A8;, www.parachute.gr.  All rights reserved.

 ? 2014 MyFonts Inc
*/
var protocol=document.location.protocol;"https:"!=protocol&&(protocol="http:");var count=document.createElement("script");count.type="text/javascript";count.async=!0;count.src=protocol+"//hello.myfonts.net/count/2a2052";var s=document.getElementsByTagName("script")[0];s.parentNode.insertBefore(count,s);var browserName,browserVersion,webfontType;if("undefined"==typeof woffEnabled)var woffEnabled=!0;var svgEnabled=0;
...
for(var fonts=[{fontFamily:"PFDinMono-Medium",url:wfpath+"2A2052_0"+suffix+"_0."+webfontType},{fontFamily:"PFDinMono-Regular",url:wfpath+"2A2052_1"+suffix+"_0."+webfontType},{fontFamily:"PFDinMono-Light",url:wfpath+"2A2052_2"+suffix+"_0."+webfontType},{fontFamily:"PFDinMono-Bold",url:wfpath+"2A2052_3"+suffix+"_0."+webfontType}],len=fonts.length,css="",i=0;i<len;i++){var format="svg#wf"==webfontType?'format("svg")':"ttf"==webfontType?'format("truetype")':"eot"==webfontType?"":'format("'+webfontType+
