/*
 ...
 MyFonts Webfont Build ID 2708770, 2013-12-16T04:38:53-0500
 ...
 License: http://www.myfonts.com/viewlicense?type=web&buildid=2708770

 ? 2013 MyFonts Inc
*/
var protocol=document.location.protocol;"https:"!=protocol&&(protocol="http:");var count=document.createElement("script");count.type="text/javascript";count.async=!0;count.src=protocol+"//hello.myfonts.net/count/295522";var s=document.getElementsByTagName("script")[0];s.parentNode.insertBefore(count,s);var browserName,browserVersion,webfontType;if("undefined"==typeof woffEnabled)var woffEnabled=!0;var svgEnabled=0;
...
for(var fonts=[{fontFamily:"PFDinMono-Medium",url:wfpath+"295522_0"+suffix+"_0."+webfontType},{fontFamily:"PFDinMono-Regular",url:wfpath+"295522_1"+suffix+"_0."+webfontType},{fontFamily:"PFDinMono-Bold",url:wfpath+"295522_2"+suffix+"_0."+webfontType},{fontFamily:"AGaramond-Regular",url:wfpath+"295522_3"+suffix+"_0."+webfontType},{fontFamily:"AGaramondAlt-Regular",url:wfpath+"295522_4"+suffix+"_0."+webfontType},{fontFamily:"AGaramondExp-Regular",url:wfpath+"295522_5"+suffix+"_0."+webfontType},{fontFamily:"GillSansMTStd-Medium",
url:wfpath+"295522_6"+suffix+"_0."+webfontType},{fontFamily:"GillSansMTStd-Book",url:wfpath+"295522_7"+suffix+"_0."+webfontType}],len=fonts.length,css="",i=0;i<len;i++){var format="svg#wf"==webfontType?'format("svg")':"ttf"==webfontType?'format("truetype")':"eot"==webfontType?"":'format("'+webfontType+'")',css=css+("@font-face{font-family: "+fonts[i].fontFamily+";src:url("+fonts[i].url+")"+format+";");fonts[i].fontWeight&&(css+="font-weight: "+fonts[i].fontWeight+";");fonts[i].fontStyle&&(css+="font-style: "+
