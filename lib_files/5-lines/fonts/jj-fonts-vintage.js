/*
 ...
 MyFonts Webfont Build ID 2788519, 2014-04-04T06:16:53-0400
 ...
 Webfont: Century Schoolbook Roman by Bitstream
 ...
 Webfont: Rockwell Std by Monotype 
 ...
 License: http://www.myfonts.com/viewlicense?type=web&buildid=2788519

 ? 2014 MyFonts Inc
*/
var protocol=document.location.protocol;"https:"!=protocol&&(protocol="http:");var count=document.createElement("script");count.type="text/javascript";count.async=!0;count.src=protocol+"//hello.myfonts.net/count/2a8ca7";var s=document.getElementsByTagName("script")[0];s.parentNode.insertBefore(count,s);var browserName,browserVersion,webfontType;if("undefined"==typeof woffEnabled)var woffEnabled=!0;var svgEnabled=0;
...
for(var fonts=[{fontFamily:"CenturySchoolbookBT-Roman",url:wfpath+"2A8CA7_0"+suffix+"_0."+webfontType},{fontFamily:"PFDinMono-Medium",url:wfpath+"2A8CA7_1"+suffix+"_0."+webfontType},{fontFamily:"PFDinMono-Regular",url:wfpath+"2A8CA7_2"+suffix+"_0."+webfontType},{fontFamily:"PFDinMono-Light",url:wfpath+"2A8CA7_3"+suffix+"_0."+webfontType},{fontFamily:"PFDinMono-Bold",url:wfpath+"2A8CA7_4"+suffix+"_0."+webfontType},{fontFamily:"RockwellStd",url:wfpath+"2A8CA7_5"+suffix+"_0."+webfontType}],len=fonts.length,
