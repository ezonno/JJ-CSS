/*
 ...
 MyFonts Webfont Build ID 2774190, 2014-03-20T11:17:16-0400
 ...
 License: http://www.myfonts.com/viewlicense?type=web&buildid=2774190

 ? 2014 MyFonts Inc
*/
var protocol=document.location.protocol;"https:"!=protocol&&(protocol="http:");var count=document.createElement("script");count.type="text/javascript";count.async=!0;count.src=protocol+"//hello.myfonts.net/count/2a54ae";var s=document.getElementsByTagName("script")[0];s.parentNode.insertBefore(count,s);var browserName,browserVersion,webfontType;if("undefined"==typeof woffEnabled)var woffEnabled=!0;var svgEnabled=0;
...
for(var fonts=[{fontFamily:"CenturySchoolbookBT-Roman",url:wfpath+"2A54AE_0"+suffix+"_0."+webfontType},{fontFamily:"PFDinMono-Medium",url:wfpath+"2A54AE_1"+suffix+"_0."+webfontType},{fontFamily:"PFDinMono-Regular",url:wfpath+"2A54AE_2"+suffix+"_0."+webfontType},{fontFamily:"PFDinMono-Light",url:wfpath+"2A54AE_3"+suffix+"_0."+webfontType},{fontFamily:"PFDinMono-Bold",url:wfpath+"2A54AE_4"+suffix+"_0."+webfontType}],len=fonts.length,css="",i=0;i<len;i++){var format="svg#wf"==webfontType?'format("svg")':
