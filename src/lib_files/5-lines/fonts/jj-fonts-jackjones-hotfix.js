/*
 ...
 MyFonts Webfont Build ID 2893034, 2014-10-01T08:07:11-0400
 ...
 License: http://www.myfonts.com/viewlicense?type=web&buildid=2893034
 ...
 ? 2014 MyFonts Inc
*/
var protocol=document.location.protocol;"https:"!=protocol&&(protocol="http:");var count=document.createElement("script");count.type="text/javascript";count.async=!0;count.src=protocol+"//hello.myfonts.net/count/2c24ea";var s=document.getElementsByTagName("script")[0];s.parentNode.insertBefore(count,s);var browserName,browserVersion,webfontType;if("undefined"==typeof woffEnabled)var woffEnabled=!0;var svgEnabled=0;
...
for(var fonts=[{fontFamily:"DINNextLTPro-Bold",url:wfpath+"2C24EA_0"+suffix+"_0."+webfontType},{fontFamily:"DINNextLTPro-Medium",url:wfpath+"2C24EA_1"+suffix+"_0."+webfontType},{fontFamily:"DINNextLTPro-Regular",url:wfpath+"2C24EA_2"+suffix+"_0."+webfontType}],len=fonts.length,css="",i=0;i<len;i++){var format="svg#wf"==webfontType?'format("svg")':"ttf"==webfontType?'format("truetype")':"eot"==webfontType?"":'format("'+webfontType+'")',css=css+("@font-face{font-family: "+fonts[i].fontFamily+";src:url("+
